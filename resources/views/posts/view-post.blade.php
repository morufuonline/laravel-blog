<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <p>{{ $gen_helper::full_date($post->created_at) }}</p>
    </x-slot>
    ...
    <div class="py-4 min-h-500">
        ...
        <div class="mt-4 text-right text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0"><a href="posts/edit/{{ $post->id }}" style="color:#f11;">Edit</a></div>
